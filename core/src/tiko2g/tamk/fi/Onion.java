...
//        batch.draw(new Texture("badlogic.jpg"), rect.x, rect.y, rect.width, rect.height);
    ...
    private Vector2[] getVertices(){
        ...
        vertices[0] = new Vector2(0.83f, 2.75f);
        vertices[1] = new Vector2(1.74f, 3.52f);
        vertices[2] = new Vector2(2.34f, 3.52f);
        vertices[3] = new Vector2(2.63f, 1.97f);
        vertices[4] = new Vector2(2.51f, 0.56f);
